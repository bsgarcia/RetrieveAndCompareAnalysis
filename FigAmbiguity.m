...
for exp_num = selected_exp
    ...
    sc2 = scatter(xout, yout, 22, 'MarkerFaceColor', lin3.Color,...
        'MarkerEdgeColor', 'w');
    sc2.MarkerFaceAlpha = alpha(i);
      sc2 = scatter(symp.*100, EA.*100, 15, 'MarkerFaceColor', lin3.Color,...
        'MarkerEdgeColor', 'w');
    ...
    sc2.MarkerFaceAlpha = alpha(i);
    hold on
    sc2 = scatter(symp.*100, SA.*100, 15, 'MarkerFaceColor', lin3.Color,...
        'MarkerEdgeColor', 'w');
    sc2.MarkerFaceAlpha = .4;
