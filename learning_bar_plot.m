...
function plot_bar_plot_correct_choice_rate(d, idx, orange_color, blue_color, exp_names)
    ...
    for exp_name = {exp_names{:}, exp_names{end}}
        ...
        mn = [mn1, mn2];
        err1 = std(corr_rate_exp_vs_exp)/sqrt(size(corr_rate_exp_vs_exp, 1));
        err2 = std(corr_rate_desc_vs_exp)/sqrt(size(corr_rate_desc_vs_exp, 1));
        err = [err1, err2];
        ...
        p2_1 = plot([1.55, 2.35],...
            ...
            'Color', orange_color, 'LineStyle', '--', 'LineWidth', 2.7);
        
        p2_2 = plot([1.55, 2.35],...
            ones(1, 2) .* mean(corr_rate2{i}),...
            'Color', orange_color, 'LineWidth', 2.7);
        legend([p2_2, p2_1],...
