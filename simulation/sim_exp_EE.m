function [a, cont1, cont2, p1, p2, ev1, ev2] = sim_exp_EE(exp_name, d, idx, sess, def, nagent)
    ...
    Q = get_qvalues(alpha1, cho, cfcho, con, out, cfout, ntrials);
    ...
    for agent = 1:nagent
        for sub = 1:nsub    
            ...
            for t = 1:ntrials
                ...
                v = [flatQdef(map(s1(t))), flatQ(map(s2(t)))];
